...
This folder contains runbooks + reference docs for the **Proactive Guardian Care** prototype.
...
## Existing reference docs (already in repo)
...
Position rebuild 的 repo source of truth 在 `docs/frontend-position/`.

- [`frontend-position/00-master-plan.md`](frontend-position/00-master-plan.md)
- [`frontend-position/00-governance.md`](frontend-position/00-governance.md)
- [`frontend-position/01-phase-foundation.md`](frontend-position/01-phase-foundation.md)
- [`frontend-position/02-phase-command.md`](frontend-position/02-phase-command.md)
- [`frontend-position/03-phase-production.md`](frontend-position/03-phase-production.md)
