...
// ??????雓??
#define DEVICE_ID "ESP32_0000A022A443CA48"
#define CLOCK_DEVICE_LABEL "HO CHI WAI"
...
// #define IMPACT_THRESHOLD 2.5          // ?????????(g)?雓????
...
#define MAP_GRID_COLOR 0x52AA       // ???揖???賹???塗? (??雓???
#define MAP_BORDER_COLOR 0xFFFF     // ?鞎????????(??????
#define CURRENT_POS_COLOR 0xF800    // ??丐???????謚??城???(??∵????
#define TARGET_POS_COLOR 0x07E0     // ????????謚??城???(??皝??
...
#define SOS_HOLD_TIME 3000          // 3?雓????

// ???????????雓??
#define NTP_SERVER "pool.ntp.org"

// ?????雓??
#define AUDIO_VOLUME_DEFAULT 80        // ??秋鬥餈???? 0-100
#define AUDIO_BUFFER_SIZE 4096         // ?????啾縑????豯叟????
#define AUDIO_TASK_STACK_SIZE 8192     // Audio alerts/TTS need headroom for SD + I2S
#define AUDIO_TASK_PRIORITY 1          // ????鞊?????????
...
#define BCLKPIN 18      // ??????
#define WSPIN 13        // ???????謆????????
#define DIPIN 17        // ?????鞎?雓??(DIN)
#define DOPIN 12        // ?????鞎?雓??(DOUT)
#define MCLKPIN 21       // ?鞊????

// ?????????雓??
#define WRIST_RAISE_THRESHOLD 0.5     // ????????雓?????

// ??????雓??
#define VIB_MOTOR_PIN 9               // ??????雓???雓ａ擐?
#define VIB_SHORT_MS 100              // ??雓???
#define VIB_LONG_MS 500               // ??镼????

// ?鞊?????????
#define PRIORITY_LOCATION 3           // ???豱????窄???
#define PRIORITY_UPLOAD 2             // ?鞊船謑????窄???
#define PRIORITY_DISPLAY 1            // ???????窄???
